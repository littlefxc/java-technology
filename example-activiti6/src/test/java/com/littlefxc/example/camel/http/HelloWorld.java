 ...
 *
 * http请求：curl http://127.0.0.1:8282/doHelloWorld -X POST -d '{"username":"admin"}' -H "Content-Type:application/json"
 *
 * @author fengxuechao
 */
public class HelloWorld extends RouteBuilder {
    ...
    public class HttpProcessor implements Processor {
        ...
        public void process(Exchange exchange) throws Exception {
            ...
            log.info("exchange.getFromEndpoint() = {}", exchange.getFromEndpoint());
            log.info("exchange.getFromEndpoint().getClass() = {}", exchange.getFromEndpoint().getClass());
